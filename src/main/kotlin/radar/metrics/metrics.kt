...
fun greatCircle(point1: Point2D, point2: Point2D): Float {
    ...
    val diffLat = Math.toRadians((lon2 - lon1).toDouble())
    val diffLon = Math.toRadians((lat2 - lat1).toDouble())

    val radiusStartLat = Math.toRadians(lon1.toDouble())
    val radiusEndLat = Math.toRadians(lat1.toDouble())
