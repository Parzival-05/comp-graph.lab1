...
class CatParticleTest {
    ...
    fun `test default state is CALM`() {
        val cat = CatParticle(coordinates = Point2D(0.0, 0.0), Point2D(0.0, 0.0))
    ...
    fun `test unique IDs are assigned`() {
        val cat1 = CatParticle(coordinates = Point2D(0.0, 0.0), Point2D(0.0, 0.0))
        val cat2 = CatParticle(coordinates = Point2D(1.0, 1.0), Point2D(0.0, 0.0))
