...
/**
 * Abstract base class representing the overall simulation or "scene" containing particles.
 *
 ...
 * @property particles The list of particles currently present in the scene.
 */
abstract class BaseScene<P : BaseParticle<T, O>, T : BasePoint<O>, O : BaseOffset<T>, C : BaseCollision<P, T, O>, OG : BaseOffsetGenerator<P, T, O>>(
     ...
     *
     * @param offsetGenerator The offset generator used to calculate particle movements.
     */
     ...
     *
     * @param offsetGenerator The offset generator used to compute movements for particles.
     */
     ...
     *
     * This abstract method must be implemented in subclasses to detect collisions based on
     * custom rules or physics simulations.
     *
    ...
    /**
     * Reacts to the detected collisions, modifying the state of particles as needed.
     *
     * This abstract method must be implemented in subclasses to define specific reaction behavior
     * (e.g., resolving overlaps, computing bounce directions).
     *
